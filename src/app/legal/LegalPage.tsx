...
export function LegalPage({
  ...
  return (
    <main className="flex-1 w-full flex justify-center p-8">
      <article className="max-w-2xl w-full space-y-6 font-mono text-sm leading-relaxed [&_h2]:mt-8 [&_h2]:text-[#7FFF6A] [&_p]:text-[#E6DFC8]/85 [&_a]:underline [&_a]:underline-offset-4">
